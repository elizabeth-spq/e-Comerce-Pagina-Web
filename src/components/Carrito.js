    ...
    return (
        <section id="carrito" className='padded'>
            <div className="container">
                <h2 className='titleTextb pb-4'>Carrito</h2>
                <div className="row">
                    <div className="col-md-8">
                        <table className="table">
                            <thead className="table-light">
                                <tr>
                                    <th className='pt-5'>Cod</th>
                                    <th>Nombre</th>
                                    <th>Precio</th>
                                    <th>Cantidad</th>
                                    <th>Subtotal</th>
                        ...
                        <button className='btn bigButton mx-5'
                            >Aplicar Cupón</button>
                            <button className='btn bigButton ms-5'
                            >Actualizar</button>
                    ...
                    <div className="col-md-4">
                        ...
                        <button className='btn bigButton ms-5 w-100'
